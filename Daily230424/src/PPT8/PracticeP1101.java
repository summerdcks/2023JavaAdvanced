...
//특정종목 모두 추출하기
	public static void main(String[] args) throws IOException {
		...
		File f1_k36= new File("C:\\Users\\DataSWB\\Desktop\\samsung.csv");
		...
		while((readtxt_k36 = br_k36.readLine()) != null) {	//파일 끝까지 한 줄씩 읽어들임
			...
			if(field_k36.length > 2 && field_k36[2].replace("^", "").trim().substring(0, 7).contains("A005930")) {
				//만약 필드 수가 2보다 크고 2번째 필드의 0부터 7번째까지의 문자열에 A005930이 담겨있다면
